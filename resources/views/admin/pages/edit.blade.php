    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('admin.pages.update', $page) }}">
            ...
            <div class="form-group">
                ...
                <textarea id="content" data-image-url="{{ route('admin.ajax.upload.image') }}" class="summernote form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" name="content" rows="10" required>{{ old('content', $page->content) }}</textarea>
